...
void MF_EM_Gauges::setRPM (float value)
{
    RPM = value;
}

void MF_EM_Gauges::setInstrumentBrightnessRatio(float ratio)
{
...
void MF_EM_Gauges::setPowerSave(bool enabled)
{
    if (enabled) {
...
float MF_EM_Gauges::scaleValue(float x, float in_min, float in_max, float out_min, float out_max)
{
